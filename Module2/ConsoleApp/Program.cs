...
class Program
{
    static void Main()
    {
        ...
        // Task 3: Array and Loops
        #region Loops
        // Declare an array of ints of size 5
        int[] numbers = new int[5];

        // Use a loop to initialize the values in the range of 1 to 5
        ...
        Console.WriteLine("Does this printer have paper? (Y/N)");
        ...
        switch (condition)
        {
            ...
            case "NYN":
                ...
                break;
            case "NNY":
                Console.WriteLine("Turn on the printer and check for a printer jam.");
                break;
            case "NNN":
                Console.WriteLine("Turn on the printer and load paper.");
                break;
